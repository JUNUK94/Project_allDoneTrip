				...
				<div class="row">
					...
					<div class="col-lg-6 col-sm-12 col-md-6">
						<div class="sub_menu_social_icon">
							<a href="#"> <i class="flaticon-facebook"></i>
							</a> <a href="#"> <i class="flaticon-twitter"></i>
							</a> <a href="#"> <i class="flaticon-skype"></i>
							</a> <a href="#"> <i class="flaticon-instagram"></i>
							</a> <span> <i class="flaticon-phone-call"></i> +81
								2-2153-3245
							</span>
						</div>
					</div>
					...
					<div class="col-lg-12">
						<nav
							...
							<a class="navbar-brand" href="/"> <img
								src="http://alldonetrip.shop/resources/img/basic/logo/logo2.png"
							...
							<div
								...
								<ul class="navbar-nav">
									...
									<li class="nav-item dropdown"><a
										...
										aria-haspopup="true" aria-expanded="false"> planner </a>
										<div class="dropdown-menu" aria-labelledby="navbarDropdown">
											<a class="dropdown-item" href="/planner/write"> 나만의 플래너
												작성하기 </a> <a class="dropdown-item" href="/planner/list"> 모두의
												플래너 </a>
										</div></li>
									<li class="nav-item dropdown"><a
									...
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
											...
											<a class="dropdown-item" href="top_place.html">나의 게시글</a> <a
												class="dropdown-item" href="tour_details.html">스크랩</a> <a
												class="dropdown-item" href="elements.html">회원정보수정</a>
										</div></li>
									<li class="nav-item"><a class="nav-link"
							...
							<ul class="navbar-nav">
								<c:if test="${email == null}">
									<li class="nav-item"><a class="nav-link text-primary"
										href="/login/loginMain">Log in</a></li>
									<li class="nav-item"><a class="nav-link text-primary"
										href="/login/signUpList">Sign up</a></li>
								</c:if>
								<c:if test="${email != null}">
									<li class="nav-item"><a class="nav-link text-primary"
										href="/">
