						...
						<nav class="navbar navbar-expand-lg navbar-light justify-content-between">
							...
							<div
								...
								<ul class="navbar-nav">
									...
									<li class="nav-item">
										<a class="nav-link" href="/trip/city/countryList">Tour Info</a></li>
									...
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
											<a class="dropdown-item" href="tour_details.html">전체</a> 
											<a class="dropdown-item" href="top_place.html">여행 후기</a> 
											<a class="dropdown-item" href="tour_details.html">동행 찾기</a>
											<a class="dropdown-item" href="elements.html">서로서로 답해요</a>
										</div>
									</li>
									<li class="nav-item dropdown">
										<a 	class="nav-link dropdown-toggle" href="blog.html"
