...
<body>
	...
	<div class="row mt-2 text-center" >
		...
		<div class="row mt-3 " >
			...
			<div class="col "><input type="text" class="form-control" placeholder="Email" id="email" name="email" value="${userInfo.email }"></div>
		</div>
		<div class="row" >
			<div class="col-2"></div>
			<div class="col-8">
		...
		<div class="row mt-3" >
			...
			<div class="col "><input type="text" class="form-control" placeholder="nick_Name" id="nick_Name" name="nick_Name" value="${userInfo.nickname}"></div>
		</div>
		<div class="row" >
			<div class="col-2"></div>
			<div class="col-8">
