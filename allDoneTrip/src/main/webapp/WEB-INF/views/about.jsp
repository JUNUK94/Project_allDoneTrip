...
<head>
    ...
    <!-- fontawesome CSS -->
    <link rel="stylesheet" href="../resources/main/fontawesome/css/all.min.css">
    <!-- magnific CSS -->
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../resources/main/img/services_1.png" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../resources/main/img/services_2.png" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../resources/main/img/services_3.png" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../resources/main/img/services_4.png" alt="">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-columns">
                        <div class="card">
                            <a href="../resources/main/img/gallery/gallery_1.png" class="gallery_img">
                               <img src="../resources/main/img/gallery/gallery_1.png" class="card-img-top" alt="">
                            </a>
                        </div>
                        <div class="card">
                            <a href="../resources/main/img/gallery/gallery_3.png" class="gallery_img">
                                <img src="../resources/main/img/gallery/gallery_3.png" class="card-img-top" alt="">
                            </a>
                        </div>
                        <div class="card">
                            <a href="../resources/main/img/gallery/gallery_2.png" class="gallery_img">
                                <img src="../resources/main/img/gallery/gallery_2.png" class="card-img-top" alt="">
                            </a>
                        </div>
                        <div class="card">
                            <a href="../resources/main/img/gallery/gallery_4.png" class="gallery_img">
                                <img src="../resources/main/img/gallery/gallery_4.png" class="card-img-top" alt="">
                            </a>
                        </div>
                        <div class="card">
                            <a href="../resources/main/img/gallery/gallery_5.png" class="gallery_img">
                                <img src="../resources/main/img/gallery/gallery_5.png" class="card-img-top" alt="">
                            </a>
                        </div>
                      </div>
                </div>
