...
<head>
    ...
    <!-- flaticon CSS -->
    <link rel="stylesheet" href="../resources/css/main/flaticon.css">
    <!-- fontawesome CSS -->
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="single_place">
                        <img src="../resources/main/img/single_place_1.png" alt="">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="single_place">
                        <img src="../resources/main/img/single_place_2.png" alt="">
                        <div class="hover_Text d-flex align-items-end justify-content-between">
                            <div class="hover_text_iner">
                                <a href="#" class="place_btn">travel</a>
                                <h3>Saintmartine Iceland</h3>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="single_place">
                        <img src="../resources/main/img/single_place_3.png" alt="">
                        <div class="hover_Text d-flex align-items-end justify-content-between">
                            <div class="hover_text_iner">
                                <a href="#" class="place_btn">travel</a>
                                <h3>Saintmartine Iceland</h3>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="single_place">
                        <img src="../resources/main/img/single_place_4.png" alt="">
                        <div class="hover_Text d-flex align-items-end justify-content-between">
                            <div class="hover_text_iner">
                                <a href="#" class="place_btn">travel</a>
                                <h3>Saintmartine Iceland</h3>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../resources/main/img/ind/industries_1.png" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../resources/main/img/ind/industries_2.png" alt="">
                        <div class="hover_text">
                            <div class="hotel_social_icon">
                                <ul>
                                    <li><a href="#"><i class="ti-facebook"></i></a></li>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="../resources/main/img/ind/industries_3.png" alt="">
                        <div class="hover_text">
                            <div class="hover_text">
                                <div class="hotel_social_icon">
                                    <ul>
